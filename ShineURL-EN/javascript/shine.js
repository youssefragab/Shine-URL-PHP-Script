  ...
  if(url == ""){
    ...
    swal({
      ...
      if (result.dismiss === 'timer') {
        ...
        swal({
        html: '<h2 class="shorted-url z-depth-2">' + returnedURL +'</h2> <div class="copy-container"><center><div class="copy z-depth-3" data-clipboard-target="#copylink"><img src="images/copy.png"> Copy</div></center></div>      '
